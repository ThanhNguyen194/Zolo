package com.qr.chatappproject.ui;
...
import com.qr.chatappproject.MainActivity;
import com.qr.chatappproject.R;
import com.qr.chatappproject.data.SharedPreferenceHelper;
import com.qr.chatappproject.data.StaticConfig;
import com.qr.chatappproject.model.User;
...
public class LoginActivity extends AppCompatActivity {
    private static String TAG = "tienthanh20212283m";
...
//                            Log.d(TAG, "createUserWithEmail:mAuth:" + mAuth.getTenantId());
//                            Log.d(TAG, "createUserWithEmail:myRef:" + myRef);
//                            Log.d(TAG, "createUserWithEmail:user:" + user.getUid());
//                            Log.d(TAG, "createUserWithEmail:authUtils:" + authUtils);
//                            Log.d(TAG, "createUserWithEmail:mAuthListener:" + mAuthListener);
        ...
        void initNewUserInfo() {
            ...
            Log.d("tienthanh","uid user: " +user.getUid());
